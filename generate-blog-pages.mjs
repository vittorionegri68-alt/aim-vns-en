...
const SITE_URL = "https://en.aim-vns.com";
...
<html lang="en">
  ...
  <body>
    <div class="wrap">
      <div class="top-nav">
        <a href="${SITE_URL}/#blog">← Back to the site</a>
...
${bodyBlocks}
      ...
      <div class="ig-cta">
        <p>Want to know how AI assistants find you? The first analysis is free.</p>
        <a class="btn-link" href="${CALENDLY_URL}" target="_blank" rel="noopener noreferrer">Free analysis</a>
      </div>
      <footer><a href="${SITE_URL}/">AI'm by VNS - Back to home</a></footer>
    </div>
    <script>
      (function () {
