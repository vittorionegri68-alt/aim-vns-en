// AI'm by VNS — config.js (EN)
// Update URLs after Vercel deploy

export const config = {
  brand: {
    name: "AI'm by VNS",
    tagline: "Be Found. Grow.",
    settore: "AI visibility for small businesses",
    anno: "2026",
  ...
  urls: {
    it: "https://www.aim-vns.com",
    en: "https://en.aim-vns.com",
    nl: "https://nl.aim-vns.com",
    xDefault: "https://www.aim-vns.com",
    ogImage: "/og-image.jpg",
  },
  ga4: {
    id: "G-NQ5G31HN3T", // replace with real ID before going live
  },
  design: {
    colors: {
      bg:      "#080808",
