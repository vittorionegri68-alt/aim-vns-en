...
const cases = [
  {
    ...
    nota: 'Analysis April 2026 — next update July 2026',
  },
  {
    nome: 'RAB Romagna',
    luogo: 'Romagna, IT',
    settore: 'Short-term rentals',
    ...
    nota: 'Analysis April 2026 — system validated before launch',
  },
]
    ...
    <div style={{ marginBottom: '12px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: '#555',
          letterSpacing: '0.1em', textTransform: 'uppercase' }}>Before</span>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0 4px' }}>
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: '#A0782A',
          letterSpacing: '0.1em', textTransform: 'uppercase' }}>After</span>
      ...
      <div style={{ background: '#141414', height: '3px' }}>
        <div style={{ background: '#A0782A', height: '3px',
          width: animate ? `${after * 10}%` : '0%', transition: 'width 0.8s ease' }} />
      </div>
    </div>
  )
}
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 clamp(24px,4vw,64px)' }}>
        <div style={{ marginBottom: 'clamp(40px,5vw,64px)' }}>
          <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '10px',
            ...
            marginBottom: '1rem' }}>Real examples</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)',
          gap: '1px', background: '#141414' }} className="cases-grid">
          {cases.map((c, i) => (
            <div key={i} style={{ background: '#0a0a0a',
              ...
              <div style={{ fontFamily: "'Inter', sans-serif", fontSize: '10px',
                ...
                marginTop: '1rem', borderTop: '1px solid #141414', paddingTop: '1rem' }}>{c.nota}</div>
            </div>
          ))}
        </div>
      </div>
