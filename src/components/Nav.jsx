...
export default function Nav() {
  ...
  return (
    <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: '8px' }}>
            {[
              ...
              { code: 'EN', url: 'https://en.aim-vns.com',  active: true },
              { code: 'NL', url: 'https://nl.aim-vns.com',  active: false },
            ].map(l => (
              <a key={l.code} href={l.url} style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '10px', letterSpacing: '0.15em', color: l.active ? '#ffffff' : '#333', textDecoration: l.active ? 'underline' : 'none', textUnderlineOffset: '3px', transition: 'color 0.2s' }}
      ...
      <style>{`
        @media (max-width: 768px) { .nav-links-desktop { display: none !important; } .whatsapp-label { display: none; } }
      `}</style>
    </nav>
  )
}
