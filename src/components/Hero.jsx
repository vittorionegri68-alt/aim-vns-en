...
// v2.1 — muted color #AAAAAA, data strip removed — june 2026
    ...
    <section style={{ background: '#080808', paddingTop: '64px', minHeight: '100vh',
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 clamp(24px,4vw,64px)',
        ...
        <h1 style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 700,
          ...
          <span style={{ display: 'block', color: '#ffffff' }}>GETTING FEWER</span>
          <span style={{ display: 'block', color: '#A0782A' }}>ENQUIRIES</span>
          <span style={{ display: 'block', color: '#1f1f1f' }}>THAN BEFORE?</span>
        </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto',
          ...
          <div>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400,
              ...
              People have stopped searching only on Google.
              Now they ask ChatGPT. If your business does not show up there,
              those customers go somewhere else.
            </p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'flex-end' }}>
            ...
            >Find out if they can find you - free</a>
