  ...
  return (
    <div style={{ background: '#0a0a0a', borderTop: '2px solid #A0782A',
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between',
        ...
        >{condiviso ? 'Link copied ✓' : 'Share ↗'}</button>
      ...
      {(() => {
        ...
        return (
          <div style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #1A1A1A' }}>
            <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '9px', color: '#AAAAAA', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '1rem' }}>Read also</div>
            {altri.map((p, k) => (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)',
            ...
            {active.map((p) => (
              ...
              >
                ...
                <button onClick={() => openArticle(p.id)} style={{
